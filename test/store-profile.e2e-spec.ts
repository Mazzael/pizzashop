...
test('update profile successfully', async ({ page }) => {
  ...
  await page.getByText('Pefil da loja').click()
  ...
  await page.waitForLoadState('networkidle') // esperar concluir a requisição http
...
test('update profile error', async ({ page }) => {
  ...
  await page.getByLabel('Nome').fill('asrsdarfpjrfd')
